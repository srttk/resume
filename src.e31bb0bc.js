...
console.log("⚡️" + _package.default.description);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var now = new Date();
  currentYearSpan.textContent = now.getFullYear(); // Set back to home button

  if (window.location && window.location.search.trim() === "?utm_source=sarath.tk") {
    var gobackOrigin = document.querySelector("#go-back-origin");
    gobackOrigin.href = "https://sarath.tk";
  }
});
},{"./styles/index.scss":"styles/index.scss","../package.json":"../package.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
